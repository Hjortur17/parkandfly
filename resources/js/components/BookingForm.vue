<template>
	<div class="p-0">
		...
		<section class="w-full mt-8 md:mt-16" id="service-form" v-if="step === 5">
			<div class="w-full">
				<h2 class="font-bold text-white text-4xl text-center">Greiða fyrir bókun</h2>
			</div>

			<form class="max-w-xl">
				<div class="flex flex-wrap">
					<input type="text" class="bg-white px-2 py-1 w-full" placeholder="Kortanr.">
					<input type="text" class="bg-white px-2 py-1 w-full" placeholder="Gildistími">
					<input type="text" class="bg-white px-2 py-1 w-full" placeholder="CVC">

					<button class="bg-orange-500 text-white font-bold text-center px-4 py-1 rounded">Borga</button>
				</div>
			</form>
